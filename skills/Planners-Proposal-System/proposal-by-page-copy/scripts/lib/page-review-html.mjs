...
.fact-exception{margin:0 0 15px;border:1px solid #d7aa5f;background:var(--warn-soft);border-radius:8px;padding:13px 15px}
...
function render(){
  ...
  REVIEW.pages.forEach(page => {
    ...
    const factExceptions = page.requires_fact_decision
      ? '<div class="fact-exception"><h3>需要你决定的事实例外</h3><p>脚本无法机械完成以下核对。本页不会默认通过，请确认来源与表述是否可接受，或选择“需要修改”。</p>' +
